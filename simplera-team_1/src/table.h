...
public:
    ...
    Table(string tableName, string source);
    bool load();
    void GraphSortPass0();
    void MergePass(int runSize);
    void Merge(int leftIndex, int rightIndex, int runSize, string outputTableName, int &outputPageIndex);
...
public:
    ...
    Table *NodesTable;
    Table *EdgesTable;
    Table *SortedNodesTable;
    Table *SortedEdgesTable;
    Table *IndexTable;

    string sourceNodeName;
    string sourceEdgeName;

    Graph(string graphName, string graphType);
    void load();
